...
or directories. But also gives users the ability to type text if they dont have a file.
...
that already start with . or wrap. will not be rewrapped but instead ingnored.
...
paragraphs and a large number of errors within the file. Since out code reads the input a byte at a 
